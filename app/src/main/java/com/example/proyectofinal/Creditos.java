...
public class Creditos extends AppCompatActivity {
        ...
        nav_view.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if(id == R.id.historico){
                    Intent ri = new Intent(Creditos.this, RegistroHistorico.class);
                    startActivity(ri);
                }
                    ...
                    Intent ins = new Intent(Creditos.this, Instrucciones.class);
                    startActivity(ins);
                }
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        if(id == R.id.create_alert){
            Toast.makeText(Creditos.this, "CREATE ALERT", Toast.LENGTH_SHORT).show();
